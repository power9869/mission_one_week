...
def get_student_info(students, student_id):
    ...
    return f"이름: {student['name']}, 점수: {student['score']}, 등급: {grade}"


# 테스트 코드
print(get_student_info(students, '102'))
print(get_student_info(students, 104))
print(get_student_info(students, '999'))
print(get_student_info(students, 'abc'))